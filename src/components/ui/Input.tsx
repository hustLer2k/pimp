...
const Input = forwardRef(function Input(
	...
	return (
		<div className="-space-y-px shadow-sm">
			...
			{error && (
				<p
					className="border-red-500 dark:border-red-400 text-grey-900 dark:text-gray-300 relative block w-full appearance-none
                              rounded-t-md border px-3 py-2 sm:text-sm"
				>
					{error}
				</p>
			)}
